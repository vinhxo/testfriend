...
namespace Unity.Services.Samples.Friends
{
    ...
    public class RelationshipsManager : MonoBehaviour
    {
        ...
        async Task LogInAsync()
        {
            ...
            await AuthenticationService.Instance.UpdatePlayerNameAsync("vinh");
            Debug.LogError(AuthenticationService.Instance.PlayerName);
            ...
            await FriendsService.Instance.SetPresenceActivityAsync(new Characters
            {
                RecentChar = "vinh1111"
            });
        ...
        void RefreshFriends()
        {
            ...
            foreach (var friend in friends)
            {
                ...
                //recent character
                recentCharacterText = friend.Presence.GetActivity<Activity>() == null
                    ? ""
                    : friend.Presence.GetActivity<Activity>().RecentChar;
                ...
                var info = new FriendsEntryData
                {
                    ...
                    RecentCharacter = recentCharacterText,
                    /*RecentCharacter = "xxxxxxxxx",*/
                };
        ...
        async Task AcceptRequest(string playerName)
        {
            try
            {
                ...
                Debug.LogError($"Friend request from {playerName} was accepted.");
            }
            catch (RelationshipsServiceException e)
            {
